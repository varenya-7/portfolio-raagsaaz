...
const Discography = () => {
  const [ref, inView] = useInView({
    triggerOnce: false, // Always trigger when in view
    threshold: 0.1,      // Trigger when 10% is visible
  });

  return (
    <section id="discography" className="py-20 bg-zinc-800" ref={ref}>
      <h1
        className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-medium mb-12 font-sans w-fit mx-auto lg:ml-28 lg:-mt-8 tracking-wider  leading-[1.3]  text-center lg:text-left pb-2"
